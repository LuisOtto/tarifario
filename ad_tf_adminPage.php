    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <iframe src="Tarifario.pdf" width="100%" height="500px"></iframe>
            </div>
            <div class="modal-footer">
...
<div class="modal fade bd-example-modal-xl" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalLabel">Cliente, email, direccion</h5>
                                ...
                                <div class="card-footer">
                                    <div>
                                        <div class="col-md-15 mb-4" >
                                            <div>
                                                <label for="periodsAssig">Accion</label>
                                                <select class="form-control">
                                            ...
                                            <div class="form-check" style="margin-top:15px;;">
                                                <h6>Contactos</h6>
                                                <label class="label">Usuario 1 - Departamento</label></br>
                                                <label class="label">Usuario 2 - Departamento</label></br>
                                                <label class="label">Usuario 3 - Departamento</label></br>
                                                <label class="label">Usuario 4 - Departamento</label></br>
                                                <label class="label">Usuario 5 - Departamento</label></br>
                                                <label class="label">Usuario 6 - Departamento</label></br>
                                            </div>
                                            <div>
                                                <div class="input-group input-group-sm mb-3">
                                                    ...
                                                    <input type="text-md" class="form-control" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div class="col-md-15 mb-4" >
                                            <div>
                                                ...
                                                <select class="form-control">
                                                    <option value="">Notificacion</option>
                                                    <option value="">Solicitud de confirmacion</option>
                                                </select>
                                            </div>
                                            <div class="form-check" style="margin-top:15px;;">
                                                <h6>Contactos</h6>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-dismiss="modal"><i class="fas fa-file-import"></i></button>
